		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
					...
					<!-- 水果商店 -->
			<diy_fruit_mall v-if="form.source_table === 'fruit_mall'" :query="{fruit_mall_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_fruit_mall>
...
<script>
	import mixin from "../../mixins/page.js";
			import diy_fruit_mall from "../../components/diy/diy_fruit_mall.vue";
