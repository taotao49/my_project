				...
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="分类">
						<el-select v-model="query.cart_type">
							...
							<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="水果产地">
									<el-input v-model="query.fruit_origin"></el-input>
								</el-form-item>
				</el-col>
				</el-row>
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="user_group == '管理员' || $check_action('/fruit_mall/table','add') || $check_action('/fruit_mall/view','add')" @click="$router.push('./view?')">添加</el-button>

						

						<el-button v-if="user_group == '管理员' || $check_action('/fruit_mall/table','del') || $check_action('/fruit_mall/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="cart_description" label="描述" min-width="200">
				...
				<el-table-column prop="fruit_origin" @sort-change="$sortChange" label="水果产地"
				v-if="user_group == '管理员' || $check_field('get','fruit_origin')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="user_group == '管理员' || $check_action('/fruit_mall/table','set') || $check_action('/fruit_mall/view','set') || $check_action('/fruit_mall/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<div class="view_a">
					<router-link class="e-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/fruit_mall/table','set') || $check_action('/fruit_mall/view','set') || $check_action('/fruit_mall/view','get')"
						:to="'./view?' + field + '=' + scope.row[field]"
						 size="small">
						<span>详情</span>
					</router-link>
						<router-link v-if="user_group == '管理员' || $check_comment('/fruit_mall/table')" class="e-button e-button--small is-plain el-button--primary"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/fruit_mall/get_list?like=0",
				url_del: "~/api/fruit_mall/del?",
